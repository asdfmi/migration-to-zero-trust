...
import (
	...
	"migration-to-zero-trust/gateway/internal/config"
	"migration-to-zero-trust/gateway/internal/controlplane"
	"migration-to-zero-trust/gateway/internal/firewall"
	"migration-to-zero-trust/gateway/internal/logging"
	"migration-to-zero-trust/gateway/internal/wireguard"
)
...
func main() {
	...
	log.Printf("starting gateway iface=%s", env.WGInterface)
	...
	applyFn := func(cfg *controlplane.GatewayConfig) error {
